  ...
  <el-dialog v-model="addStuVisible" title="添加学生" width="35%" style="border-radius: 15px">
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="primary" @click="addStuVisible = false"> 确定 </el-button>
      </span>
    </template>
  </el-dialog>
  <el-dialog v-model="addTchVisible" title="添加教师" width="35%" style="border-radius: 15px">
    <div style="display: flex; justify-content: center">
      <el-form
        label-position="left"
        label-width="100px"
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="primary" @click="addTchVisible = false"> 确定 </el-button>
      </span>
    </template>
  </el-dialog>
