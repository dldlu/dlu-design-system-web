...
export const queryUserbyCollege = (
  collegeId: string,
  isStu: string,
  size: string,
  num: string,
) =>
  requests.get<userDesc>(
    `/user/info/college/${collegeId}/${isStu}/${size}/${num}`,
  );

export const queryUserbyNumberMajor = (
  number: string,
  majorId: string,
  isStu: string,
